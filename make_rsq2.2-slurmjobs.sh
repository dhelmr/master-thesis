...
SLURM_MEM_GB=30 SLURM_HOURS=48 slurm/run.sh tsa-fs -i results/rsq2-2/$1.csv -o results/rsq2-2/fs/$1-depth=$2rounds=$3.csv -p DecisionTree --skip-features $SKIP_FEATURES --max-depth $2 --minmax-scaling --total $3 $4
}
