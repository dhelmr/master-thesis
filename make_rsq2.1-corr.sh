...
python cli.py tsa-correlate -i results/rsq2-1/perf-augmented.csv -o results/rsq2-1/perf.corr-f1.csv --target f1_cfa $COMMON_ARGS
python cli.py tsa-correlate -i results/rsq2-1/perf-augmented.csv -o results/rsq2-1/perf.corr-pr.csv --target precision_with_cfa $COMMON_ARGS
python cli.py tsa-correlate -i results/rsq2-1/perf-augmented.csv -o results/rsq2-1/perf.corr-dr.csv --target detection_rate $COMMON_ARGS
