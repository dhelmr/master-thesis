...
def calc_time_deltas(recording_list, description):
    results = {
        'normal': [],
        'exploit': []
    }
...
if __name__ == '__main__':
    ...
    for scenario in SCENARIO_NAMES:
        ...
        for data_part in data_parts.keys():
            results = calc_time_deltas(data_parts[data_part],
        ...
        # fig.show()
        fig.write_image(
            f'/home/tk/Documents/Uni/Theorie/Citsci.project.report/images/CVE-2019--Test-data-time_delta.pdf')
